...
export const UploaderPage: React.FC = () => {
  ...
  return (
    <section className="UploaderPage">
      ...
      <button onClick={handleFileDownload}>Download file222</button>
      <button onClick={handleDownload}>Download file333</button>
      <button onClick={handleLoad}>Download file111</button>
    </section>
  );
};
